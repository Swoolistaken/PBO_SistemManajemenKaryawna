...
public class InputData extends JDialog {
    ...
    private JScrollPane buatPanelForm() {
        ...
        btnHitung.addMouseListener(new MouseAdapter() {
            @Override public void mouseEntered(MouseEvent e) { btnHitung.setBackground(new Color(50, 105, 170)); }
            @Override public void mouseExited(MouseEvent e)  { btnHitung.setBackground(new Color(70, 130, 200)); }
        });
    ...
    private JPanel buatPanelTombol() {
        ...
        btnBatal.addMouseListener(new MouseAdapter() {
            @Override public void mouseEntered(MouseEvent e) { btnBatal.setBackground(new Color(100, 100, 120)); }
            @Override public void mouseExited(MouseEvent e)  { btnBatal.setBackground(new Color(130, 130, 150)); }
        });
        ...
        btnSimpan.addMouseListener(new MouseAdapter() {
            @Override public void mouseEntered(MouseEvent e) { btnSimpan.setBackground(new Color(20, 110, 20)); }
            @Override public void mouseExited(MouseEvent e)  { btnSimpan.setBackground(new Color(34, 139, 34)); }
        });
