    ...
    private JPanel buatPanelFitur() {
        ...
        for (String[] f : fitur) {
            ...
            kartu.addMouseListener(new MouseAdapter() {
                @Override public void mouseEntered(MouseEvent e) { kartu.setBackground(new Color(55, 65, 95)); }
                @Override public void mouseExited(MouseEvent e)  { kartu.setBackground(new Color(42, 46, 60)); }
            });
