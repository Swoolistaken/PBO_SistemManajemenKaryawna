...
public class ModelKPI {
    ...
    public String getGradeKPI() {
        ...
        if (nilai >= 90) return "A+ (Luar Biasa)";
        if (nilai >= 80) return "A (Sangat Baik)";
        if (nilai >= 70) return "B (Baik)";
        if (nilai >= 60) return "C (Cukup)";
        if (nilai >= 50) return "D (Perlu Perbaikan)";
        return "E (Tidak Memenuhi Standar)";
    }

    public double getBonusKPI(double gajiPokok) {
        double nilai = hitungNilaiAkhir();
        if (nilai >= 90) return gajiPokok * 0.20;
        if (nilai >= 80) return gajiPokok * 0.15;
        if (nilai >= 70) return gajiPokok * 0.10;
        if (nilai >= 60) return gajiPokok * 0.05;
        return 0;
    }
    ...
    public void setBulan(int bulan) {
        if (bulan < 1 || bulan > 12) throw new IllegalArgumentException("Bulan harus antara 1-12!");
        this.bulan = bulan;
    }

    public double getNilaiProduktivitas() { return nilaiProduktivitas; }
    ...
    public double getNilaiKualitas() { return nilaiKualitas; }
    ...
    public double getNilaiKehadiran() { return nilaiKehadiran; }
    ...
    public double getNilaiTeamwork() { return nilaiTeamwork; }
    ...
    public double getNilaiInovasi() { return nilaiInovasi; }
    ...
    public String getTargetPeriodeBerikutnya() { return targetPeriodeBerikutnya; }
    public void setTargetPeriodeBerikutnya(String targetPeriodeBerikutnya) { this.targetPeriodeBerikutnya = targetPeriodeBerikutnya; }

    public Date getTanggalPenilaian() { return tanggalPenilaian; }
    public void setTanggalPenilaian(Date tanggalPenilaian) { this.tanggalPenilaian = tanggalPenilaian; }

    public String getPenilai() { return penilai; }
    public void setPenilai(String penilai) { this.penilai = penilai; }
}
