...
/**
 * Table Model untuk JTable Karyawan
 * Implementasi: INHERITANCE (extends AbstractTableModel)
 */
public class ModelTable extends AbstractTableModel {
    ...
    @Override
    public String getColumnName(int col) { return KOLOM[col]; }
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            case 0: return row + 1;
            case 1: return k.getNik();
            case 2: return k.getNama();
            case 3: return k.getJabatan();
            case 4: return k.getDepartemen();
            case 5: return getLevelLabel(k.getLevelJabatan());
            case 6: return rupiah.format(k.getGajiPokok());
            case 7: return rupiah.format(k.hitungTotalGaji());
            case 8: return k.getStatus();
            default: return "";
        }
    }
