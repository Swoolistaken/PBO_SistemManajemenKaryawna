...
/**
 * DAO untuk operasi database KPI
 * Implementasi: INHERITANCE (implements InterfaceDAO), EXCEPTION HANDLING, JDBC
 */
public class DAOKPI implements InterfaceDAO<ModelKPI> {
    ...
    public int getTotal() throws SQLException {
        try (Statement st = getConn().createStatement();
             ResultSet rs = st.executeQuery("SELECT COUNT(*) FROM kpi")) {
